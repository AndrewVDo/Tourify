        ...
        <div className="register-app">
            ...
            <table id="registration-table">
                <tbody>
                    <tr>
                        <td>
                            <img
                                ...
                                src={
                                    props.loginInfo.additionalUserInfo.profile
                                        .picture
                                }
                                alt="user profile"
                            ></img>
                    ...
                    <tr>
                        ...
                        <td>
                            <TextField
                                id="weight"
                                onChange={event =>
                                    setFormDataField(event, 'weight', true)
                                }
                                InputLabelProps={{ shrink: true }}
                            ></TextField>
                        </td>
                    ...
                    <tr>
                        <td>
                            <InputLabel id="date-of-birth-label">
                                Date of Birth
                            </InputLabel>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <Select
                                ...
                                onChange={event =>
                                    setFormDataField(event, 'user-type')
                                }
                            >
                                {userTypeList.map(elem => (
                                    <MenuItem key={elem} value={elem}>
                                        {elem}
                                    </MenuItem>
                                ))}
